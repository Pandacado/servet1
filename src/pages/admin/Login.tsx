      ...
      >
        ...
        <div className="relative bg-white/10 backdrop-blur-md p-10 rounded-3xl shadow-2xl border border-white/20">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-300">Servet Dekorasyon Yönetim Sistemi</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl focus:ring-2 focus:ring-[#E67E22] focus:border-transparent transition-all duration-300 text-white placeholder-gray-400"
                  placeholder="••••••••"
                />
                <button
                  type="button"
          ...
          <div className="text-center mt-8 pt-6 border-t border-white/10">
            ...
            <Link
              to="/admin/register"
              className="text-[#E67E22] hover:text-[#F39C12] font-semibold transition-colors duration-300 mr-6"
            >
